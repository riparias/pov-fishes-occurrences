...
-- TAXON
  CASE
    ...
    WHEN o."ScientificName" = 'Chelon labrosus' THEN 'Chelon labrosus'
    ...
    WHEN o."ScientificName" = 'Merlangius merlangus' THEN 'Merlangius merlangus'
    ...
    WHEN o."ScientificName" = 'Perccottus glenii' THEN 'Perccottus glenii'
    ...
    WHEN o."ScientificName" = 'Salmo salar' THEN 'Salmo salar'
  ...
  CASE
    ...
    WHEN o.DutchName = 'Amoergrondel' THEN 'amoergrondel'
    ...
    WHEN o.DutchName = 'Diklipharder' THEN 'diklipharder'
    ...
    WHEN o.DutchName = 'Wijting' THEN 'wijting'
    WHEN o.DutchName = 'winde' THEN 'winde'
    WHEN o.DutchName = 'Winde' THEN 'winde'
    WHEN o.DutchName = 'Zalm' THEN 'Atlantische zalm'
